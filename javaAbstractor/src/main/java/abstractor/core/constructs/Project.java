...
public class Project implements Jsonable {
    ...
    public final Factory<DeclarationRef> declRefs       = new Factory<DeclarationRef>(ConstructKind.DECLARATION_REF);
    ...
    public final Factory<TypeDescRef>    typeDescRefs   = new Factory<TypeDescRef>   (ConstructKind.TYPE_DESC_REF);
    public final Factory<TypeParam>      typeParams     = new Factory<TypeParam>     (ConstructKind.TYPE_PARAM);
    public final Factory<TypeParamRef>   typeParamRefs  = new Factory<TypeParamRef>  (ConstructKind.TYPE_PARAM_REF);
