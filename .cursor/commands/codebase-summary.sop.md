...
### Optional Parameters
- **output_dir**: Directory where documentation will be stored (default: ".agents/summary")
- **consolidate**: Whether to create consolidated documentation files (default: true)
- **consolidate_targets**: Target files for consolidation, comma-separated (e.g., "AGENTS.md, README.md, CONTRIBUTING.md"). Only used if consolidate is true (default: "AGENTS.md")
