...
Type `/` followed by `pdd` in the Cursor chat to execute this workflow.

## Parameters
When you execute this command, I will prompt you for the following parameters:
### Required Parameters
- **rough_idea**: The initial concept or idea you want to develop into a detailed design
### Optional Parameters
- **project_name**: A short, descriptive name for the project. If not provided, will be generated from the rough idea
- **project_dir**: The base directory where all project files will be stored (default: ".agents/planning/{project_name}")
