...
func (v *valueImp) Package() declarations.Package { return v.pkg }

func (v *valueImp) CompareTo(other constructs.Construct) int {
	return constructs.CompareTo[Value](v, other, Comparer())
}

func Comparer() comp.Comparer[Value] {
