...
func Test_T0007(t *testing.T) { newTest(t, `test0007`).abstract().dump().full() }
func Test_T0008(t *testing.T) { newTest(t, `test0008`).abstract().dump().full() }
func Test_T0009(t *testing.T) { newTest(t, `test0009`).abstract().dump().full() }

func Test_T0010(t *testing.T) { newTest(t, `test0010`).abstract().dump().full() }
func Test_T0011(t *testing.T) { newTest(t, `test0011`).abstract().dump().full() }
func Test_T0012(t *testing.T) { newTest(t, `test0012`).abstract().dump().full() }

func Test_T0013(t *testing.T) { newTest(t, `test0013`).abstract().dump().full() }
func Test_T0014(t *testing.T) { newTest(t, `test0014`).abstract().dump().full() }
func Test_T0015(t *testing.T) { newTest(t, `test0015`).abstract().dump().full() }
